...
>
  ...
  {:else if href.includes("docs.google.com/spreadsheets")}
    <iframe
      class="pointer-events-none relative top-[1px] -mx-3 mb-[calc(-56.25%_-_2.25rem)] mt-2 aspect-video w-[calc(200%_+_3rem_+_4px)] origin-top-left scale-50"
  ...
  {:else if href.includes("docs.google.com/document")}
    <iframe
      size="0.5"
      class="pointer-events-none relative top-[1px] -mx-4 mb-[calc(-100%_-_2.25rem)] mt-2 aspect-square w-[calc(200%_+_3rem_+_8px)] origin-top-left scale-50 bg-white px-8"
